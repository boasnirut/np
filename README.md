...
ระบบรองรับคอมพิวเตอร์ แท็บเล็ต และโทรศัพท์มือถือ มีเมนูแบบ Dropdown, หน้าต้อนรับแบบสไลด์, Billboard Banner, ข่าวสาร วิดีโอประชาสัมพันธ์ รายงาน SAR ผลงาน เอกสารบริการ แบบฟอร์ม Q&A และช่องทางรับเรื่องร้องเรียน
...
- หน้าต้อนรับพร้อมสไลด์ภาพ เลื่อนอัตโนมัติทุก 5 วินาที และจัดการภาพ/สถานะ/ลำดับได้จากระบบบริหาร
- เลือก “ไม่แสดงข้อความนี้อีกวันนี้” ได้
- Billboard Banner อัตราส่วนแนะนำ 4:1 เลื่อนอัตโนมัติทุก 5 วินาที และจัดการได้จากระบบบริหาร
- สรุปข่าวสาร ปฏิทินกิจกรรม ผลงานและรางวัล จดหมายข่าว รายงาน SAR และวิดีโอประชาสัมพันธ์
...
- ITA Online
- SAR สถานศึกษา แสดงเล่มรายงาน PDF และเปิดอ่านจาก Google Drive/เว็บไซต์ได้

หน้าประกันคุณภาพภายนอกแบ่งหลักฐานเป็นระดับปฐมวัยและระดับการศึกษาขั้นพื้นฐานตามมาตรฐานและตัวชี้วัด โดยจัดเป็น Accordion สามระดับ ได้แก่ มาตรฐาน ตัวชี้วัด และรายการหลักฐาน เพื่อรองรับข้อมูลจำนวนมากโดยไม่ทำให้หน้าเว็บยาวหรือรก แต่ละแถวแสดงจำนวนหลักฐานและสรุปชนิดไฟล์ก่อนเปิดดู ผู้ดูแลสามารถกำหนดชื่อแยกให้ไฟล์หรือลิงก์หลักฐานแต่ละรายการ และชื่อนั้นจะใช้กับภาพตัวอย่าง ตัวอ่าน PDF และปุ่มเปิดไฟล์ ระบบตรวจชนิดไฟล์จากลิงก์ Google Drive ให้อัตโนมัติและมีตัวเลือกให้ระบุ PDF รูปภาพ โฟลเดอร์ Google Drive หรือไฟล์ประเภทอื่นด้วยตนเอง ลิงก์โฟลเดอร์จะแสดงเป็นการ์ดไอคอนโฟลเดอร์พร้อมปุ่มเปิด หากหลักฐานเป็นรูปภาพ ระบบจะแสดงภาพตัวอย่างและเปิดดูภาพเต็มได้ พร้อมซูม เลื่อนภาพ และเปลี่ยนภาพก่อนหน้า/ถัดไป ส่วนหลักฐาน PDF จะแสดงตัวอย่างและเปิดอ่านแบบเต็มหน้าจอภายในเว็บไซต์ พร้อมเครื่องมือซูม เลื่อนหน้า และปุ่มเปิดไฟล์ต้นฉบับ
...
- ประกาศ
- จดหมายข่าว
- วิดีโอประชาสัมพันธ์จาก YouTube หรือ Google Drive พร้อมตัวเล่นภายในเว็บไซต์
...
| `sar` | รายงาน SAR สถานศึกษา |
| `documents` | เอกสารและแบบคำร้อง |
| `qa` | ตอบคำถามจาก Q&A |
| `complaints` | ตรวจสอบและอัปเดตสถานะเรื่องร้องเรียน |
| `slides` | ภาพหน้าต้อนรับและ Billboard Banner |
| `staff` | ข้อมูล รูปภาพ และเว็บไซต์บุคลากร |

สมาชิกที่ได้รับสิทธิ์ในส่วนงานสามารถเพิ่มข้อมูล และแก้ไขหรือลบได้เฉพาะรายการที่ตนเองเป็นผู้สร้าง โดยระบบตรวจเจ้าของรายการจากช่อง `author` ทั้งในหน้าจอและ Serverless API ผู้ดูแลระบบมีสิทธิ์ทุกส่วนโดยอัตโนมัติและแก้ไข/ลบได้ทุกรายการ รวมถึงการจัดการสมาชิก การกำหนดลำดับ และการเลือกเผยแพร่ Q&A

### ความสามารถในการจัดการเนื้อหา

- ข่าวสาร: หัวข้อ หมวดหมู่ วันที่ สรุป รายละเอียด รูปภาพ และไฟล์/ลิงก์แนบ โดยหมวดวิดีโอประชาสัมพันธ์รับเฉพาะลิงก์ YouTube/Google Drive และไม่รับไฟล์วิดีโออัปโหลดโดยตรง
...
- ภาพหน้าเว็บไซต์: เพิ่มหรือเปลี่ยนภาพหน้าต้อนรับและ Billboard Banner กำหนดคำอธิบายภาพ เปิด/ปิด และเรียงลำดับการแสดง
- ข้อมูลบุคลากร: เพิ่มหรือแก้ไขชื่อ ตำแหน่ง กลุ่มบุคลากร รูปภาพ เว็บไซต์ เปิด/ปิด และลำดับการแสดง
- SAR สถานศึกษา: เพิ่มชื่อรายงาน ปีการศึกษา รายละเอียด และแนบลิงก์หรืออัปโหลดไฟล์ PDF
...
- หากวันที่ตรงกัน ผู้ดูแลระบบสามารถลากสลับรายการจากรายการด้านข้างในหน้าบริหารจัดการ
- เอกสารหลักฐาน สมศ. ลากสลับได้ภายในระดับการศึกษาและตัวชี้วัดเดียวกัน ส่วนภาพหน้าเว็บไซต์และบุคลากรลากสลับภายในประเภทเดียวกัน
- เมื่อมีการลาก ระบบจะแสดงปุ่ม **ยืนยันการเปลี่ยนลำดับ** และบันทึกลำดับทั้งหมดเป็น GitHub commit เดียว
- ค่า `display_order` ยังคงถูกเก็บภายใน CSV แต่ระบบคำนวณให้อัตโนมัติ ผู้ใช้งานไม่ต้องกรอกตัวเลขเอง
- รายการสถานะ `draft` จะไม่ถูกส่งไปแสดงในหน้าสาธารณะ
- ภาพหน้าต้อนรับและ Billboard เรียง `display_order` จากเลขน้อยไปมาก และสถานะ `draft` หมายถึงปิดการแสดง
...
| `data/news.csv` | ข่าวกิจกรรม ประชาสัมพันธ์ ประกาศ และลิงก์วิดีโอประชาสัมพันธ์ |
...
| `data/sar.csv` | รายงาน SAR สถานศึกษาและลิงก์ไฟล์ PDF |
...
| `data/site-slides.csv` | ภาพหน้าต้อนรับ Billboard สถานะ และลำดับการแสดง |
| `data/staff.csv` | ข้อมูลบุคลากร รูปภาพ เว็บไซต์ สถานะ และลำดับการแสดง |
...
│   ├── services.js        # API กลางสำหรับ SAR เอกสาร Q&A เรื่องร้องเรียน ภาพเว็บไซต์ และบุคลากร
